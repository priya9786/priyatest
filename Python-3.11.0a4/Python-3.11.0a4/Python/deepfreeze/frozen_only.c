...
toplevel_code = {
    ...
    .ob_shash = -1,
    .ob_sval = "\x97\x00\x64\x00\x5a\x00\x65\x01\x64\x01\xa9\x01\x01\x00\x64\x02\x53\x00",
};
static
    struct {
...
toplevel_linetable = {
    ...
    .ob_shash = -1,
    .ob_sval = "\x02\x80\x04\x00\x0c\x01",
};
static
    struct {
        PyObject_VAR_HEAD
...
toplevel_columntable = {
    ...
    .ob_shash = -1,
    .ob_sval = "\x00\x00\x0f\x13\x01\x0c\x01\x06\x07\x15\x01\x16\x01\x16\x01\x16\x01\x16",
};
static
    struct {
        PyObject_VAR_HEAD
